...
1. Launch the game in Unity or build as a standalone application.  
2. Move the basket horizontally with the mouse to catch apples.  
3. **Catch apples** to gain points (+100 per apple).  
